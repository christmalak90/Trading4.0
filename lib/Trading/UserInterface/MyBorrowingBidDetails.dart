...
class MyBorrowingBidDetails extends StatefulWidget {
  final String transactionId;

  const MyBorrowingBidDetails({Key? key, required this.transactionId}) : super(key: key);

  @override
  _MyBorrowingBidDetailsState createState() => _MyBorrowingBidDetailsState();
}

class _MyBorrowingBidDetailsState extends State<MyBorrowingBidDetails> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: buildAppBar("MY BORROWING BID DETAILS", Colors.grey, Colors.white),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        (bidder.userId == FirebaseAuth.instance.currentUser!.uid) ? "My borrowing bid" : "Borrowing bid",
  ...
  Future<void> getMyBorrowingBidDetails() async {
