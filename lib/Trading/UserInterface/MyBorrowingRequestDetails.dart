...
class MyBorrowingRequestDetails extends StatefulWidget {
  final String transactionId;

  const MyBorrowingRequestDetails({Key? key, required this.transactionId}) : super(key: key);

  @override
  _MyBorrowingRequestDetailsState createState() => _MyBorrowingRequestDetailsState();
}

class _MyBorrowingRequestDetailsState extends State<MyBorrowingRequestDetails> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: buildAppBar("MY REQUEST DETAILS", Colors.grey, Colors.white),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  displayAlert(
                      ...
                      Text(
                        "Do you really want to cancel this borrowing request",
                        style: TextStyle(
                          color: Colors.red,
                          fontSize: 12,
                        ),
  ...
  Future<void> getMyBorrowingRequestDetails() async {
  ...
  Widget cancelRequestSubmitButton() {
    return ElevatedButton(
      ...
      onPressed: () async {
        ...
        if (value == "success") {
          displayToastMessage("Borrowing request cancelled", "success", context);
